...
\input{src/peskin_qft_1.tex}
\input{src/peskin_qft_2.tex}
\input{src/peskin_qft_3.tex}
\input{src/peskin_qft_4.tex}
\input{src/peskin_qft_5.tex}
\part{Renormalization}
\input{src/peskin_qft_6.tex}
\input{src/peskin_qft_7.tex}
\input{src/peskin_qft_8.tex}
\input{src/peskin_qft_9.tex}
\part{Non-Abelian Gauge Theories}
\input{src/peskin_qft_10.tex}
\input{src/peskin_qft_11.tex}
\input{src/peskin_qft_12.tex}
\input{src/peskin_qft_13.tex}
\input{src/peskin_qft_14.tex}
\input{src/peskin_qft_15.tex}
\input{src/peskin_qft_16.tex}
